...
export default function CallToAction() {
  return (
    <section className="mt-4 mb-4 py-4 relative w-[90%] mx-auto overflow-hidden ">
      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center justify-center px-4 text-center">
        {/* Main Heading */}
        <h2 className="text-black mb-4 max-w-4xl font-bold tracking-tight text-neutral-900 mb-4 text-6xl font-normal leading-tight">
          Trang Bị Hoàn Hảo
          <span className="block font-bold italic">Cho Mọi Hành Trình</span>
        </h2>

        {/* Subtitle */}
        <p className="text-neutral-600 mb-10 max-w-2xl text-lg text-gray-200 sm:text-xl md:text-2xl">
